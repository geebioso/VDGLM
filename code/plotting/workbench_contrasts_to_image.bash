...
for i in ${IDX[@]}; do 
     ...
     source workbench_contrasts_format.bash ${THRESH[$i]}
     THRESH_NAME=${THRESH_NAMES[$i]}
 
     # print images from scene file 
     ITER=1
     for c in ${CONTRASTS[@]}; do 
         wb_command -show-scene cohens_d_whs26_${THRESH_NAME}.scene $c ../../images/wb_contrasts/${c}_cohens_d_whs26_${THRESH_NAME}.png \
