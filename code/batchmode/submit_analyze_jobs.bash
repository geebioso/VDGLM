...
do
    ...
    # submit job 
    qsub -v whsim=$1,dotest=$2,isHPC=$3,start_subj=$i,end_subj=$END_SUBJ,logging=$7,logfile=$8,set_up_directory_structure=$9 \
        -N ${SUFFIX} -e error_log/${SUFFIX}.err \
        -o output_log/${SUFFIX}.out ${10}
done
